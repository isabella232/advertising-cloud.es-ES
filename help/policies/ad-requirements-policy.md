---
title: Política de requisitos de publicidad de Adobe
...
* **Falsificación o falsificación de productos**. Los anuncios no pueden promocionar ni representar productos falsificados o falsos, incluidos documentos falsos, como pasaportes o documentos oficiales.
...
* **Anuncios odiados**. Los anuncios no pueden promover o relacionarse con el discurso de odio o la intolerancia religiosa y no pueden menoscabar a una persona o grupo por motivos de raza u origen étnico, religión, discapacidad, condición médica o genética, edad, nacionalidad u origen nacional, condición de veterano de guerra, condición de refugiado, situación de inmigración, orientación sexual, género, identidad de género u otra característica que esté asociada con la discriminación o marginación sistémicas.

* **Eventos confidenciales**. Los anuncios pueden no capitalizar o no tener una sensibilidad razonable hacia cualquier desastre natural, conflicto, muerte, epidemia, pandemia, trágico acontecimiento o miedo público.

* **Esquemas de pirámide**. Los anuncios no pueden promover esquemas piramidales, oportunidades de marketing multinivel, cartas en cadena u otros esquemas de &quot;enriquecimiento rápido&quot;. Cualquier Anuncio que incluya oportunidades de generación de ingresos debe contener una explicación completa del modelo de negocio.

* **Venta de partes del cuerpo**. Los anuncios no podrán promover la venta de partes del cuerpo o fluidos corporales.

* **Distracción de anuncios**. Los anuncios no pueden contener características o contenido que distraen, no sean deseables o incómodos, incluidas las funciones de reproducción automática (como anuncios que reproducen automáticamente audio o vídeo), contenido que parpadea, sacude, pulsa, parpadea o contiene objetos, texto o imágenes excesivamente animados, objetos compartidos localmente (incluidas cookies flash y almacenamiento local de HTML5) y anuncios que interrumpen la experiencia del usuario (por ejemplo, superposición de otro contenido).
...
* **Segmentación prohibida**. Los anuncios no pueden dirigirse a una audiencia ni dirigirse a ella en función de ninguno de los factores siguientes, sean conocidos o inferidos:
...
* **Unión Europea**. Además, en la Unión Europea, los anuncios no pueden dirigirse a una audiencia o dirigirse a ella en función de los siguientes factores, ya se conozcan o inferyan sobre el usuario:
