...
Asegúrese de que su cuenta tenga suficiente crédito para ejecutar toda la campaña. Puede comprobar y rellenar los fondos de la cuenta en [!UICONTROL Settings] > [!UICONTROL Account] o poniéndose en contacto con el administrador de la cuenta de Adobe.
...
Asegúrese de que el estado de colocación sea &quot;[!UICONTROL Active]&quot; o &quot;[!UICONTROL Scheduled]&quot;. Además, compruebe que los otros parámetros de ubicación (como la lista del sitio, el presupuesto, el objetivo, las fechas de vuelo y la frecuencia) son correctos.
